...
{
    public static class Tafkit
    {
        public static string ConvertToText(decimal money)
        {
            ToWord toWord = new ToWord(money, new CurrencyInfo(CurrencyInfo.Currencies.Egypt));
        ...
        public CurrencyInfo(Currencies currency)
        {
            switch (currency)
            {
                case Currencies.Egypt:
                    ...
                    Arabic1199CurrencyName = "جنية مصري";
    ...
    public class ToWord
    {
        ...
        {
            InitializeClass(number, currency, String.Empty, "only.", String.Empty, "فقط لا غير");
        }
